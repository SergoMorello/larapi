...
class API extends Core_1.default {
    ...
    http(method, params) {
        const http = new Http_1.default(method, params, this);
        if (this.token) {
...
Object.defineProperty(API, "http", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: _a.instance.http
});
...
Object.defineProperty(API, "clearCacheGroup", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: _a.instance.clearCacheGroup
});
Object.defineProperty(API, "getToken", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: _a.instance.getToken
});
Object.defineProperty(API, "getUid", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: _a.instance.getUid
});
Object.defineProperty(API, "getUser", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: _a.instance.getUser
});
Object.defineProperty(API, "user", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: _a.instance.user
});
Object.defineProperty(API, "uid", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: _a.instance.uid
});
